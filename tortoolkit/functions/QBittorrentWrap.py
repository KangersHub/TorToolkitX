...
async def update_progress(
    ...
    while True:
        ...
        if len(tor_info) > 0:
            ...
            await message.edit(
                "**🗂ꜰɪʟᴇ ɴᴀᴍᴇ:** {} \n\n**🧑🏻‍🔧ꜰᴜɴᴄᴛɪᴏɴ:** 𝚈𝚘𝚞𝚛 𝚃𝚘𝚛𝚛𝚎𝚗𝚝 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚒𝚗𝚐 𝙲𝚊𝚗𝚌𝚎𝚕𝚕𝚎𝚍".format(torrent.name), buttons=None
            )
            return True
        ...
        try:
            ...
            if is_meta and (time.time() - meta_time) > get_val("TOR_MAX_TOUT"):
                ...
                await delete_this(tor_info.hash)
                await task.set_inactive(
                    "**🗂ꜰɪʟᴇ ɴᴀᴍᴇ:** {} \n\n🧑🏻‍🔧**ᴘʀᴏʙʟᴇᴍ:** 𝚈𝚘𝚞𝚛 𝚃𝚘𝚛𝚛𝚎𝚗𝚝 𝙵𝚒𝚕𝚎 𝙾𝚛 𝙼𝚊𝚐𝚗𝚎𝚝 𝙻𝚒𝚗𝚔 𝙳𝚎𝚊𝚍 𝙲𝚑𝚊𝚗𝚐𝚎 𝚃𝚑𝚎 𝚆𝚎𝚋𝚜𝚒𝚝𝚎.".format(
                        tor_info.name
                    )
                )
            ...
            try:
                if tor_info.state == "error":
                    ...
                    await message.edit(
                        "**🗂ꜰɪʟᴇ ɴᴀᴍᴇ:** {} \n\n🧑🏻‍🔧**ᴘʀᴏʙʟᴇᴍ:** 𝚎𝚛𝚛𝚘𝚛𝚎𝚍 𝚘𝚞𝚝.".format(tor_info.name),
                        buttons=None,
                        parse_mode="html",
                    )
                    torlog.error(
