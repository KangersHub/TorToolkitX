...
async def start_handler(event):
    msg = "Hi this is Anjumani tortoolkit leech bot.Join @anjumani_addict for movies"
...
async def about_me(message):
    ...
    msg = (
        "<b>Name</b>: <code>@anjumani_addict leech bot</code>\n"
        f"<b>Version</b>: <code>{__version__}</code>\n"
        f"<b>Telethon Version</b>: {telever}\n"
        f"<b>Pyrogram Version</b>: {pyrover}\n"
        "<b>Created By</b>: @Tanujairam\n\n"
        "<b>Modified By</b>: @Tanujairam\n\n"
